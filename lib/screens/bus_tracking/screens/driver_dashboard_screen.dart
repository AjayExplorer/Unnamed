...
class _DriverDashboardScreenState extends State<DriverDashboardScreen> {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text('Are you sure you want to stop location broadcasting? The bus status will be marked as inactive.'),
          actions: [
            TextButton(
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFFDA29B)),
              child: const Text('Stop Broadcasting', style: TextStyle(color: Color(0xFFB01212))),
            ),
          ],
        );
      },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Driver Portal', style: TextStyle(fontWeight: FontWeight.w800)),
                ...
                children: [
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              foregroundImage: (driver.profilePhoto != null && driver.profilePhoto!.isNotEmpty)
                                  ...
                                  : null,
                              child: const Icon(Icons.person, size: 36, color: Color(0xFF98A2B3)),
                            ),
                                  ...
                                  Row(
                                    children: [
                                      Container(
                                        ...
                                        child: Text(
                                          bus.busNumber.isEmpty ? 'No Bus' : bus.busNumber,
                                          style: const TextStyle(
                                            fontSize: 12,
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      onPressed: !provider.isTracking ? null : _showStopConfirmation,
                      ...
                      style: OutlinedButton.styleFrom(
                        side: BorderSide(color: provider.isTracking ? errorRed : Colors.grey[300]!, width: 2),
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          _buildLiveRow('Coordinates', tracking != null 
                              ? '${tracking.latitude.toStringAsFixed(5)}, ${tracking.longitude.toStringAsFixed(5)}' 
                              : 'None'),
                          const Divider(),
                          _buildLiveRow('Current Speed', tracking != null 
                              ? '${tracking.currentSpeed.toStringAsFixed(1)} km/h' 
                              : '0.0 km/h'),
                          const Divider(),
                          _buildLiveRow('Last Reached Stop', tracking != null && tracking.currentStop.isNotEmpty
                              ? tracking.currentStop
                              : 'None'),
                          const Divider(),
                          _buildLiveRow('Upcoming Stop', tracking != null && tracking.nextStop.isNotEmpty
                              ? tracking.nextStop
                              : 'None'),
                          const Divider(),
                          _buildLiveRow('Distance to Next Stop', tracking != null
                              ? '${tracking.distanceToNextStop.toStringAsFixed(2)} km'
                              : '0.00 km'),
                          const Divider(),
                          _buildLiveRow('ETA to Next Stop', tracking != null 
                              ? tracking.eta 
                              : '--'),
                        ],
                      ),
